...
export default class WelcomeMessage extends Component {
    render() {
        return (
           <section>
                <p>You might have already noticed it... <br /> 
              parmesan cheese is pretty expensive at the market - and is not even called parmesan, but parmigiano. <br />
              ...
              <p>That is where this App comes into plays. <br />
              Connecting people who are planning to travel to a Country with other people interested in a specific little item. <br /> 
